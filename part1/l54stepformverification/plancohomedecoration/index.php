...
<body>
	...
	<header>
		<!-- Start nav bar -->
			<nav class="navbar navbar-expand-lg fixed-top">
				<a href="index.html" class="navbar-brand text-light mx-3">
					...
					<span class="text-uppercase fw-bold h2 mx-2">Planco <span class="h3">Home Decoration</span></span>
				</a>
				...
				<div id="nav" class="navbar-collapse collapse justify-content-end text-uppercase fw-bold">
					<ul class="navbar-nav">
						...
						<li class="nav-item"><a href="#properties" class="nav-link menuitems">Properties</a></li>
		...
		<!-- Start banner -->
			<div class="text-light text-center text-md-end banners">
				<h1 class="display-4 bannerheaders">Welcome to <span class="display-3 text-uppercase">Planco </span><span class="text-capitalize">home decoration co.,Ltd</span></h1>
		...
		<div class="container-fluid">
			...
			<div class="container-fluid">
				...
				<div class="d-flex flex-wrap justify-content-center">
					<div class="filters house"><a href="./assets/img/gallery/image1.jpg" data-lightbox="property" data-title="image1"><img src="./assets/img/gallery/image1.jpg" alt="image1" width="200px" /></a></div>

					<div class="filters house"><a href="./assets/img/gallery/image2.jpg" data-lightbox="property" data-title="image2"><img src="./assets/img/gallery/image2.jpg" alt="image2" width="200px" /></a></div>

					<div class="filters house"><a href="./assets/img/gallery/image3.jpg" data-lightbox="property" data-title="image3"><img src="./assets/img/gallery/image3.jpg" alt="image3" width="200px" /></a></div>

					<div class="filters decoration"><a href="./assets/img/gallery/image4.jpg" data-lightbox="property" data-title="image4"><img src="./assets/img/gallery/image4.jpg" alt="image4" width="200px" /></a></div>

					<div class="filters decoration"><a href="./assets/img/gallery/image5.jpg" data-lightbox="property" data-title="image5"><img src="./assets/img/gallery/image5.jpg" alt="image5" width="200px" /></a></div>

					<div class="filters decoration"><a href="./assets/img/gallery/image6.jpg" data-lightbox="property" data-title="image6"><img src="./assets/img/gallery/image6.jpg" alt="image6" width="200px" /></a></div>

					<div class="filters decoration"><a href="./assets/img/gallery/image7.jpg" data-lightbox="property" data-title="image7"><img src="./assets/img/gallery/image7.jpg" alt="image7" width="200px" /></a></div>

					<div class="filters furniture"><a href="./assets/img/gallery/image8.jpg" data-lightbox="property" data-title="image8"><img src="./assets/img/gallery/image8.jpg" alt="image8" width="200px" /></a></div>

					<div class="filters furniture"><a href="./assets/img/gallery/image9.jpg" data-lightbox="property" data-title="image9"><img src="./assets/img/gallery/image9.jpg" alt="image9" width="200px" /></a></div>

					<div class="filters furniture"><a href="./assets/img/gallery/image1.jpg" data-lightbox="property" data-title="image10"><img src="./assets/img/gallery/image1.jpg" alt="image1" width="200px" /></a></div>

					<div class="filters office"><a href="./assets/img/gallery/image2.jpg" data-lightbox="property" data-title="image11"><img src="./assets/img/gallery/image2.jpg" alt="image2" width="200px" /></a></div>

					<div class="filters office"><a href="./assets/img/gallery/image3.jpg" data-lightbox="property" data-title="image12"><img src="./assets/img/gallery/image3.jpg" alt="image3" width="200px" /></a></div>

					<div class="filters decoration"><a href="./assets/img/gallery/image4.jpg" data-lightbox="property" data-title="image13"><img src="./assets/img/gallery/image4.jpg" alt="image4" width="200px" /></a></div>

					<div class="filters furniture"><a href="./assets/img/gallery/image5.jpg" data-lightbox="property" data-title="image14"><img src="./assets/img/gallery/image5.jpg" alt="image5" width="200px" /></a></div>

					<div class="filters furniture"><a href="./assets/img/gallery/image6.jpg" data-lightbox="property" data-title="image15"><img src="./assets/img/gallery/image6.jpg" alt="image6" width="200px" /></a></div>

					<div class="filters office"><a href="./assets/img/gallery/image7.jpg" data-lightbox="property" data-title="image16"><img src="./assets/img/gallery/image7.jpg" alt="image7" width="200px" /></a></div>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-5 text-center">
					<img src="./assets/img/etc/building4.png" class="advimages" />
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12 mb-3">
					<div class="card border-0 servicecards">
						...
						<h5 class="text-light text-uppercase fw-bold py-2 servicetxts">Dinning Room</h5>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<ul class="clientslists">
						<li><img src="./assets/img/clients/client1.png" alt="client 1" /></li>
						<li><img src="./assets/img/clients/client1.png" alt="client 2" /></li>
						<li><img src="./assets/img/clients/client3.png" alt="client 3" /></li>
						<li><img src="./assets/img/clients/client4.png" alt="client 4" /></li>
						<li><img src="./assets/img/clients/client5.png" alt="client 5" /></li>
	...
	<section>
		<div class="container">
			<div class="quotes">
				...
				<div>
					<a class="btn btn-calls" href="tel:09422042225">Call Now <i class="fas fa-phone"></i></a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container-fluid">
			<div class="col-lg-5">
				...
				<form class="" action="" method="">
					...
					<div class="form-group py-4">
						<input type="text" name="email" id="email" class="form-control inputs p-3" placeholder="Enter your Email" autocomplete="off" />
					...
					<div class="d-grid">
						<button type="submit" class="btn text-uppercase rounded-0 fw-bold submit-btns">Subscribe</button>
					</div>
	...
	<footer class="bg-dark px-5">
		<div class="container-fluid">
			<div class="row text-light py-4">
				...
				<div class="col-md-3 col-sm-6">
					<h5 class="mb-3">Need</h5>
					<ul class="list-unstyled">
						<li><a href="#" class="text-uppercase footerlinks">Customer Service</a></li>
						<li><a href="#" class="text-uppercase footerlinks">Online Chat</a></li>
						<li><a href="#" class="text-uppercase footerlinks">Support</a></li>
						<li><a href="#" class="text-uppercase footerlinks">info@palncco.com</a></li>
					</ul>
				</div>
	...
	<!-- jquery js1 -->
	<script src="./assets/libs/code.jquery.com_jquery-3.7.0.min.js" type="text/javascript"></script>
